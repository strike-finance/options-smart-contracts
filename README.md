...
## Introduction
V1 implementation of options trading on Strike Finance will be peer-to-peer (p2p). We understand Cardano has a liquidity problem and is currently exploring a pooled options alternative. This is an American Options platform, where users will have the right, but not the obligation, to exercise their contracts.
